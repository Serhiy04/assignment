...
import 'package:assignment/features/presenter/ui/widgets/boxes/crypto_card.dart';
import 'package:assignment/features/presenter/ui/widgets/buttons/add_new_big_button.dart';
import 'package:assignment/features/presenter/ui/widgets/buttons/add_new_small_button.dart';
...
class _CryptoListState extends State<CryptoList> {
  ...
  CurrencyEntity generateModel() {
    final random = Random();
    final id = currencies.length + 1;
    final model = CurrencyEntity(
      id: id,
